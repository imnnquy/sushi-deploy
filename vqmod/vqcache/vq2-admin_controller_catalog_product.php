...
class ControllerCatalogProduct extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $user_mid = $this->getUserAssociatedManufacturer();
            $this->request->post["manufacturer_id"] = $user_mid;
...
$data['entry_rvgmap_placeholder'] = $this->language->get('entry_rvgmap_placeholder');
...
$data['tab_rvgmap'] = $this->language->get('tab_rvgmap');
		...
		if (isset($this->request->post['rvgmap'])) {
    ...
    protected function getUserAssociatedManufacturer()
    {
        $this->load->model('user/user');
        $user = $this->model_user_user->getUser($this->user->getId());
        $user_mid = $user['manufacturer_id'];
        if ($user_mid == 0) {
            $user_mid = null;
        }
        return $user_mid;
