<ul id="menu">
    ...
    <li id="extension"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i>
        ...
        <ul>
            ...
            <?php } ?>
            <?php if($userac->hasPermission('access','extension/theme')) { ?>
    ...
    <li id="design"><a class="parent"><i class="fa fa-television fa-fw"></i>
    ...
    <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_reports; ?></span></a>
        <ul>
            ...
            <li><a class="parent"><?php echo $text_product; ?></a>
                <ul>
                    <li><a href="<?php echo $report_product_viewed; ?>"><?php echo $text_report_product_viewed; ?></a>
                    </li>
                    <li>
            ...
            <li><a class="parent"><?php echo $text_customer; ?></a>
                <ul>
                    ...
                    <li><a href="<?php echo $report_customer_reward; ?>"><?php echo $text_report_customer_reward; ?></a>
                    </li>
            ...
            <li><a class="parent"><?php echo $text_marketing; ?></a>
                <ul>
                    ...
                    <li>
                        <a href="<?php echo $report_affiliate_activity; ?>"><?php echo $text_report_affiliate_activity; ?></a>
                    </li>
                </ul>
            </li>
        </ul>
