...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if (!isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			// Processing Orders
			$processing_status_total = $this->model_sale_order->getTotalOrders(array('filter_order_status' => implode(',', $this->config->get('config_processing_status'))));
			...
			$data['alerts'] = $processing_status_total + $customer_total + $product_total + $review_total + $return_total + $affiliate_total;
