...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getList() {
		...
		$data['column_fkb_map'] = $this->language->get('column_fkb_map');
	...
	protected function getForm() {
		...
		$data['entry_fkb_map'] = $this->language->get('entry_fkb_map');
		...
		if (isset($this->request->post['fkb_map'])) {
			$data['fkb_map'] = $this->request->post['fkb_map'];
		} elseif (!empty($manufacturer_info)) {
			$data['fkb_map'] = $manufacturer_info['fkb_map'];
		} else {
			$data['fkb_map'] = '';
		}
