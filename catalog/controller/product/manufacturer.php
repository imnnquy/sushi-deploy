...
class ControllerProductManufacturer extends Controller {
		...
		if ($manufacturer_info) {
			...
			foreach ($results as $result) {
				...
				$data['products'][] = array(
					...
					'href-qp'     => $this->url->link('product/quick_view', 'manufacturer_id=' . $result['manufacturer_id'] . '&product_id=' . $result['product_id'] . $url)
				);
			}
	...
	public function info2() {
		...
		if ($manufacturer_info) {
			...
			$this->response->setOutput($this->load->view('product/manufacturer_info2', $data));
		} else {
			$url = '';
