...
<nav id="top-sticky">
    ...
    <div class="container">
        <div id="logo-header" class="logo logo-header">
            <?php if ($logo) { ?>
...
<?php if ($categories) { ?>
<div class="container">
    <nav id="menu-header" class="menu navbar">
        <div class="navbar-header"><span class="visible-xs menutitle"><?php echo $text_menu; ?></span>
